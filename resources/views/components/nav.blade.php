            ...
            <div class="row d-flex justify-content-end">
                <div class="col-md-12 px-5">
                    <ul class="mb-5">
                        ...
                        <li><a href="{{route('auth')}}"><span>About author</span></a></li>
                        @if(!session()->has('user'))
                        <li><a href="{{route('log')}}"><span>Log in / Register</span></a> </li>@endif
                        @if(session()->has('user'))
                            ...
                            <li><a href="{{asset('/admin')}}"><span>Admin panel</span></a> </li>@endif
                        @endif
                    </ul>
                </div>
