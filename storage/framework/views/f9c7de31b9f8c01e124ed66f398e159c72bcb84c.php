    ...
    <div class="limiter">
        <div class="container-login100" style="background-image: url('<?php echo e(asset('/')); ?>images/bg-01.jpg');">
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form action="<?php echo e(route('korisnik.update',['id'=>$kor->IdKorisnik])); ?>" method="POST" class="login100-form validate-form" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="wrap-input100 validate-input m-b-23" data-validate = "Username is reauired">
                        ...
                        <input class="input100" type="text" name="username" value="<?php echo e($kor->KorIme); ?>" placeholder="Type your username">
                        <span class="focus-input100" data-symbol="&#xf206;"></span>
                    </div>

                    <div class="wrap-input100 validate-input m-b-23" data-validate = "Email is reauired">
                        <span class="label-input100">Password</span>
                        <input class="input100" type="text" name="pass" value="<?php echo e($kor->Lozinka); ?>" placeholder="Type your email">
                        <span class="focus-input100" data-symbol="&#xf206;"></span>
                    </div>

                    <div class="wrap-input100 validate-input m-b-23" data-validate = "Email is reauired">
                        <span class="label-input100">Email</span>
                        <input class="input100" type="text" name="email" value="<?php echo e($kor->Email); ?>" placeholder="Type your email">
                        <span class="focus-input100" data-symbol="&#xf206;"></span>
                    </div>
                    ...
                    <div class="flex-col-c p-t-155">
                        <a href="<?php echo e(route('korisnik.index')); ?>" class="txt2">
                            ADMIN
                        </a>
                    </div>
                    <div class="flex-col-c p-t-155">
