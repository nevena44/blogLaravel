        ...
        <div class="container-login100" style="background-image: url('<?php echo e(asset('/')); ?>images/bg-01.jpg');">
            <table class="table">
                ...
                <?php $__currentLoopData = $komentar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <th scope="row"><?php echo e($k->IdKomentar); ?></th>
                        <td><?php echo e($k->Tekst); ?></td>
                        <td><?php echo e($k->Datum); ?></td>
                        <td><a href="<?php echo e(route("komentar.edit",['komentar'=>$k->IdKomentar])); ?>"><input type="submit" class="btn btn-primary" value="EDIT"/></a></td>
                        <td><form action="<?php echo e(route("komentar.destroy",['komentar'=>$k->IdKomentar])); ?>" method="post"> <?php echo e(method_field('DELETE')); ?> <?php echo csrf_field(); ?> <a href="#"><input type="submit" class="btn btn-primary" value="DELETE"/></a></form></td>
                    </tr>
            ...
            <div class="flex-col-c p-t-155">
                <a href="<?php echo e(route('komentar.create')); ?>" class="txt2">
